...
pub fn handle(day: Day, release: bool, dhat: bool, submit_part: Option<u8>, session_file: &str) {
    ...
    cmd_args.push("--session-file".to_string());
    cmd_args.push(session_file.to_string());
