...
fn recursive_apply(
    ...
    return recursive_apply(final_result, current_result + all_numbers[current_index], current_index + 1, all_numbers)
        || recursive_apply(final_result, current_result * all_numbers[current_index], current_index + 1, all_numbers);
}
...
fn recursive_apply_two(
    ...
    return recursive_apply_two(final_result, current_result + all_numbers[current_index], current_index + 1, all_numbers)
        || recursive_apply_two(final_result, current_result * all_numbers[current_index], current_index + 1, all_numbers)
